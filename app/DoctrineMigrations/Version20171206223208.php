 ...
 */
class Version20171206223208 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE person ADD phone VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE person ADD birth_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE person ADD gender VARCHAR(10) DEFAULT NULL');
    }
